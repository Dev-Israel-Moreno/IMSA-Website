...
class Elementor_Post_Grid_Widget extends Widget_Base {
	...
	protected function render_title() {	
		...
		<<?php echo $title_tag; ?> class="title">
            ...
            <!--<hr style=" width: 53%; border-style: solid; border-color: #FF2C21;border-width: thin;">   -->
		</<?php echo $title_tag; ?>>
		<?php
	}
	...
	protected function render_meta() {
		...
		<div class="post-grid-meta">
			...
			if ( in_array( 'author', $meta_data ) ) { ?>
				...
				<span class="post-author"><i aria-hidden="true" class="fas fa-user"></i><?php the_author(); ?></span>
			...
			if ( in_array( 'date', $meta_data ) ) { ?>
				...
				<span class="post-author"><i aria-hidden="true" class="far fa-calendar-alt"></i> <?php echo apply_filters( 'the_date', get_the_date(), get_option( 'date_format' ), '', '' ); ?></span>
