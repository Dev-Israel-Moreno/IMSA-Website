 ...
 * Version: 2.0
 * Description: Display Posts Slider or Post Carousel on your WordPress website.
...
if( !defined( 'PSAC_VERSION' ) ) {
	define( 'PSAC_VERSION', '2.0' ); // Version of plugin
}
if( !defined( 'PSAC_DIR' ) ) {
...
add_action('plugins_loaded', 'psac_load_textdomain');
